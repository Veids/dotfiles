# Generated by Powerlevel10k configuration wizard on 2020-02-09 at 20:50 +05.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 33663.
# Wizard options: powerline, lean, time, 2 lines, dotted, full frame, dark-ornaments,
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%F{white}├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{white}╰─'
  # Connect right prompt lines with these symbols.
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%F{white}─╮'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%F{white}─┤'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%F{white}─╯'
  ...
  typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION='%F{yellow}'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%n%F{cyan}@%F{red}%m'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n%F{cyan}@%F{red}%m'
  ...
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(wg\.\w+|(.*tun))[0-9]*'
  # Custom icon.
  ...
  function prompt_nvim_workspace() {
    local session_path=$HOME'/.local/share/nvim/sessions/'
    [ -f "${session_path}$(pwd | tr / %)" ] && p10k segment -f 208 -t "NVIM"
  }
